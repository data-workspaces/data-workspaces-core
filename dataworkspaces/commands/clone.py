...
def clone_command(backend:str, hostname:str, batch:bool=False, verbose:bool=False, *args) -> None:
    workspace = clone_workspace(backend, hostname, batch, verbose, *args)
    click.echo("Completed initial clone of workspace %s, will check for resources to clone..."%
               workspace.name)
