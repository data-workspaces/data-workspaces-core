...
def _get_next_element(dl:List[str], startindex:int, ignore:List[str], verbose:bool=False) -> \
...
def check_hashes(roothash:str, basedir_where_hashes_are_stored:str, local_dir:str, ignore:List[str]=[],
                 hash_fun:Callable[[str], str]=compute_hash, verbose:bool=False) -> bool:
